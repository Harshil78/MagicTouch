<%@ Page Title="" Language="C#" MasterPageFile="~/UserSide/UserMaster.master" AutoEventWireup="true" CodeFile="VendorRR.aspx.cs" Inherits="UserSide_VendorRR" %>
        		...
        		<div class="welcome_inner row">
                    ...
                    <br />
        				<div class="welcome_img">
                           ...
                           <br /><br />  <h3 >Vendor Name : <%# Eval("VendorName") %></h3>
        				</div>
                        <br />
                   ...
                   <table id="example" class="" style="width:80%">
                                <thead >
                                    <tr>
                                    <th >Vendor Name</th>
                                    <th>User Name</th>
